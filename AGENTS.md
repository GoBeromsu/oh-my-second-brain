...
- **SearchBackend seam.** The in-repo engine is the default search backend; optional backends such as qmd must be selected explicitly and fail loudly when unavailable.
