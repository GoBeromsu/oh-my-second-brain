...
| [ADR-012](./ADR-012-portable-model-contract-and-lifecycle.md) | Portable model contract and lifecycle — tracked identity, local verification, immutable embedding lineage | Accepted |
