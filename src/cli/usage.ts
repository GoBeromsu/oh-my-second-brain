...
const MAIN_USAGE_COMMANDS: readonly MainUsageCommand[] = [
  ...
  },
  {
    ...
    detailLines: [
      "             list | show | scan | check | review | answer | commit | regenerate-types",
      "             Contract meaning is supplied as explicit --proposals; it is never derived",
      "             from a file name or from template syntax.",
      "             Run `oms template --help` for leaf arguments and approval requirements.",
    ],
  },
  { name: "note", line: "  note     Guide, check, complete, audit, or get notes. The agent writes the note." },
