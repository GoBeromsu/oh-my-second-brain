...
import {
  ...
  toShellVaultPath,
  upsertClaudeHooks,
} from "../vendors/claude/claude-hooks.js";
...
function runHostOperation(options: HostOperationOptions): Promise<HostOperationResult[]> {
  return runKernelHostOperation(options, runVendorHostOperation);
}
