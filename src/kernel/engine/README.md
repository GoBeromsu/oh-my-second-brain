...
request override, then a complete environment pair, then `.oms/settings.json`,
...
sealed-contract `folders.json` `intent` values. No legacy root file, bundled default, or
