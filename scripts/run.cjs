...
'use strict';
/**
 * OMSB Cross-platform hook runner (run.cjs)
 *
 ...
 *
 * Takes script path as first argument, spawns it as ESM with stdin piped.
 * Always exits cleanly (never blocks Claude Code hooks).
 */
